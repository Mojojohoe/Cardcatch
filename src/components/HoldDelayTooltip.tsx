...
export const HUD_HOLD_TOOLTIP_RASTER_PANEL_CLASS =
  'max-w-[min(20rem,calc(100vw-2rem))] px-[1.1rem] pb-4 pt-[0.95rem] text-left text-[11px] font-semibold leading-snug text-slate-100 shadow-[0_16px_50px_rgba(0,0,0,0.65)] backdrop-blur-md sm:max-w-sm sm:text-[12px]';
