        ...
        >
          <div className="max-w-xs mx-auto space-y-6">
            ...
            <div className="space-y-4 text-[10px] leading-relaxed font-bold text-emerald-100 uppercase tracking-tight">
              ...
              <p><span className="text-yellow-400">02. HIERARCHY:</span> The Target Suit trumps all other suits. If both play Target or both play non-Target, <span className="text-white">HIGHER VALUE WINS (Ace is High)</span>.</p>
            ...
            <button onClick={onClose} className="w-full bg-emerald-800 py-3 rounded-lg font-black uppercase text-[10px]">Close Dossier</button>
          </div>
        </motion.div>
      )}
    </AnimatePresence>
